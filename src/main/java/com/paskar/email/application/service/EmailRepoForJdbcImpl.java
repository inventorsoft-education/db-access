...
import com.paskar.email.application.repositiory.jdbc.EmailRepoForJdbc;
...
@Component
public class EmailRepoForJdbcImpl implements EmailRepoForJdbc {

    private final JdbcTemplate jdbcTemplate;

    @Autowired
    public EmailRepoForJdbcImpl(JdbcTemplate jdbcTemplate) {
